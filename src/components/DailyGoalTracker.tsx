...
export const DailyGoalTracker: React.FC<DailyGoalTrackerProps> = ({
  ...
  return (
    <div id="daily-study-goal-panel" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-sm shadow-sm p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4 gap-4">
        ...
        <div className="flex items-center self-start md:self-auto">
          {isGoalAchieved ? (
            <div className="flex items-center gap-1.5 text-xs font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 px-3 py-1 rounded-sm border border-emerald-150 dark:border-emerald-800 uppercase tracking-wide">
              <Flame className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400 fill-emerald-100 dark:fill-emerald-950 animate-pulse" />
              Goal Smashed!
            </div>
          ) : (
            <div className="flex items-center gap-1.5 text-xs font-bold text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/40 px-3 py-1 rounded-sm border border-amber-150 dark:border-amber-800 uppercase tracking-wide">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col justify-between space-y-4 bg-slate-50/50 dark:bg-slate-950/40 p-5 rounded border border-slate-100 dark:border-slate-800">
          <div className="space-y-1">
            <span className="text-[10px] uppercase font-bold text-slate-400 dark:text-slate-500 font-mono tracking-widest block">
              Today's Progress
            </span>
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-xs font-black text-slate-500 dark:text-slate-400 ml-auto bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded">
                {percentage}% Done
              </span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="w-full bg-slate-200 dark:bg-slate-800 h-4 rounded-full overflow-hidden p-[2px] border border-slate-200/50 dark:border-slate-700/50">
              <div 
          ...
          {isGoalAchieved ? (
            <div className="bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200/60 dark:border-emerald-800/60 p-3.5 rounded-sm flex items-start gap-3 text-emerald-800 dark:text-emerald-300 animate-fade-in">
            ...
            <div className="bg-slate-100/50 dark:bg-slate-800/40 border border-slate-200/40 dark:border-slate-700/40 p-3.5 rounded-sm text-slate-600 dark:text-slate-300 flex items-start gap-2.5">
        ...
        <div className="lg:col-span-5 space-y-5 flex flex-col justify-between">
          ...
          <div className="space-y-2.5">
            <span className="text-[10px] uppercase font-bold text-slate-400 dark:text-slate-500 font-mono tracking-widest block flex items-center gap-1">
            ...
            <div className="flex gap-2">
              <input 
                ...
                className="flex-1 px-3 py-1.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-100 text-xs rounded-sm focus:outline-none focus:ring-1 focus:ring-[#FF9900]"
                placeholder="Custom mins"
              />
              <span className="text-[11px] self-center text-slate-400 dark:text-slate-500 font-medium font-mono">mins / day</span>
            </div>
          </div>
          ...
          <div className="space-y-2.5 pt-2 border-t border-slate-100 dark:border-slate-800">
            ...
            <div className="grid grid-cols-4 gap-1.5">
              {[5, 15, 30, 45].map(mins => (
                <button
                  ...
                  className="py-1.5 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-750 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 rounded-sm text-[10px] font-extrabold cursor-pointer transition-colors"
                >
                  +{mins}m
                </button>
              ))}
            ...
            <div className="flex gap-2">
              ...
              <button 
                ...
                className="px-3 py-1.5 bg-slate-900 dark:bg-amber-500 hover:bg-slate-800 dark:hover:bg-amber-600 text-white dark:text-slate-950 text-[10px] font-black uppercase tracking-wider rounded-sm transition-colors cursor-pointer"
              >
                Log Time
              </button>
            </div>
          ...
          <div className="flex justify-between items-center pt-2 text-[10px] text-slate-400 dark:text-slate-500 font-medium">
            ...
            <button
              ...
              className="text-slate-400 dark:text-slate-500 hover:text-rose-600 dark:hover:text-rose-400 transition-colors flex items-center gap-1 font-bold uppercase tracking-wider cursor-pointer"
            >
